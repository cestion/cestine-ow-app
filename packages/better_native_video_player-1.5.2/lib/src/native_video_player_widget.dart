...
class NativeVideoPlayer extends StatefulWidget {
  const NativeVideoPlayer({
    ...
    /// When true on Android, render via Flutter [Texture] instead of a
    /// SurfaceView platform view. Use for inline surfaces that must not
    /// punch through later routes (e.g. theater banner under Login).
    this.forceTextureMode = false,
    super.key,
  });
  ...
  /// See [NativeVideoPlayer.forceTextureMode].
  final bool forceTextureMode;
